...
bot.on('message', message => {
   ...
   message.channel.send({files: ['https://stickershop.line-scdn.net/stickershop/v1/sticker/4801391/android/sticker.png']});
	...
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/364174595961389086/393395814820478978/image.png']});
	}else if(message.content == '!srszooey'){
	message.channel.send({files: ['https://images-ext-2.discordapp.net/external/z2M17FmnsJwTJoVzVpadon43J0eqywIr42lfyLzoaGQ/https/gbf.wiki/images/9/96/Stamp194.png']});
	}else if(message.content == '!amazing'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/364174595961389086/402771737378553876/Screen_Shot_2018-01-16_at_9.30.41_pm.png']});
	}else if(message.content == '!happy'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/364174595961389086/399139045063655424/Screenshot_20180106-095530.jpg']});
	}else if(message.content == '!silvano'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/364174595961389086/662352072120860692/silvano_by_sorebird-dc115cb.jpg']});
	}else if(message.content == '!katdespair'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/364174595961389086/405996670237540354/katdespair_by_sorebird-dc115cq.png']});
	}else if(message.content == '!smuggran'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/364174595961389086/410158270419042327/1516816715885_by_sorebird-dc115lx.jpg']});
	}else if(message.content == '!djeanne'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/364174595961389086/407079298584018954/djeanne_by_sorebird-dc1axb3.png']});
	...
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/364174595961389086/662351046273794109/whylive_by_sorebird-dc1axaa.png']});
	}else if(message.content == '!silva'){
	message.channel.send({files: ['https://orig00.deviantart.net/40fb/f/2018/027/2/1/silva_by_sorebird-dc1axak.png']});
	}else if(message.content == '!huhsong'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/364174595961389086/406779427184312331/ehsong_by_sorebird-dc1axbv.png']});
	}else if(message.content == '!huhzoi'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/364174595961389086/412925943007412224/ehzoi_by_sorebird-dc1axbo.png']});
	}else if(message.content == '!sip'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/364174595961389086/412926126004895744/sip_by_sorebird-dc1axb5.png']});
	}else if(message.content == '!ferry'){
	message.channel.send({files: ['https://orig00.deviantart.net/2204/f/2018/027/e/9/ohhh_by_sorebird-dc1axaf.png']});
	}else if(message.content == '!percy'){
	message.channel.send({files: ['https://orig00.deviantart.net/59ce/f/2018/027/d/e/percy_sexy_by_sorebird-dc1axc2.png']});
	}else if(message.content == '!seox'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/364174595961389086/662356118944874508/seox_by_sorebird-dc1aydo.jpg']});
	}else if(message.content == '!vermeil'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/356371808842416130/407541786383351808/Clipboard14.png']});
	}else if(message.content == '!tomtom'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/356371808842416130/407535476942176257/Clipboard13.png']});
	}else if(message.content == '!walder'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/356371808842416130/407532758962012170/unknown.png']});
	}else if(message.content == '!lancey'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/356371808842416130/407533337205538826/Clipboard11.png']});
	}else if(message.content == '!ayer'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/356371808842416130/407531439442100234/unknown.png']});
	}else if(message.content == '!meditate'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/356371808842416130/407527522637447170/unknown.png']});
	}else if(message.content == '!katrun'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/356371808842416130/407525063366017024/Clipboard08.png']});
	}else if(message.content == '!lunalu'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/356371808842416130/407524529011949569/unknown.png']});
	}else if(message.content == '!byesong'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/356371808842416130/407524816661250050/unknown.png']});
	}else if(message.content == '!wth'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/356371808842416130/407523189799780372/Clipboard06.png']});
	}else if(message.content == '!vyrnhug'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/356371808842416130/407520939505352714/Clipboard04.png']});
	}else if(message.content == '!srslyria'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/356371808842416130/407517947293335552/Clipboard02.png']});
	}else if(message.content == '!lucius'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/364174595961389086/431112849171939329/Clipboard01.png']});
	}else if(message.content == '$ohplease'){
	message.channel.send({files: ['https://orig00.deviantart.net/d250/f/2018/035/7/c/ohplease_by_sena_nightsaber-dc25j72.png']});
	}else if(message.content == '$whotalksshitabtme'){
		message.channel.send({files: ['https://orig00.deviantart.net/2594/f/2018/035/8/d/whotalksshitabtme_by_sena_nightsaber-dc25jfc.png']});
	}else if(message.content == '$na-nani'){
		message.channel.send({files: ['https://orig00.deviantart.net/de3b/f/2018/035/5/d/nani_by_sena_nightsaber-dc25jox.png']});
	}else if(message.content == '$boi'){
		message.channel.send({files: ['https://orig00.deviantart.net/fbf1/f/2018/035/b/0/boi_by_sena_nightsaber-dc25jw0.png']});
	}else if(message.content == '$amyhmm'){
		message.channel.send({files: ['https://orig00.deviantart.net/4e75/f/2018/035/2/f/amyhmm_by_sena_nightsaber-dc25k5y.png']});
	}else if(message.content == '$saduncle'){
		message.channel.send({files: ['https://orig00.deviantart.net/01fa/f/2018/035/2/6/sadcleavage_by_sena_nightsaber-dc25kee.png']});
	}else if(message.content == '$beautiful'){
		message.channel.send({files: ['https://orig00.deviantart.net/1d12/f/2018/035/4/0/beautiful_by_sena_nightsaber-dc25kub.png']});
	}else if(message.content == '$ohmyvaleron'){
		message.channel.send({files: ['https://orig00.deviantart.net/adb0/f/2018/035/8/d/ohmyvaleron_by_sena_nightsaber-dc25l10.png']});
	}else if(message.content == '$anissmile'){
		message.channel.send({files: ['https://orig00.deviantart.net/aaba/f/2018/035/1/e/anissmile_by_sena_nightsaber-dc25l1s.png']});
	}else if(message.content == '$angryrepublicannoises'){
		message.channel.send({files: ['https://orig00.deviantart.net/112f/f/2018/035/2/4/angryrepublicannoises_by_sena_nightsaber-dc25lg0.png']});
	}else if(message.content == '$angrysimonnoises'){
		message.channel.send({files: ['https://orig00.deviantart.net/112f/f/2018/035/2/4/angryrepublicannoises_by_sena_nightsaber-dc25lg0.png']});
	}else if(message.content == '$hellopolice'){
		message.channel.send({files: ['https://orig00.deviantart.net/43f2/f/2018/035/0/8/hellopolice_by_sena_nightsaber-dc25lp1.png']});
	}else if(message.content == '$imdrunk'){
		message.channel.send({files: ['https://orig00.deviantart.net/d001/f/2018/035/1/5/imdrunk_by_sena_nightsaber-dc25lx1.png']});
	}else if(message.content == '$hotuncle4racie'){
		message.channel.send({files: ['https://orig00.deviantart.net/a2d4/f/2018/035/0/8/hotuncle4racie_by_sena_nightsaber-dc25m1n.png']});
	}else if(message.content == '$angryvero'){
		message.channel.send({files: ['https://orig00.deviantart.net/1cbd/f/2018/035/e/f/angryvero_by_sena_nightsaber-dc25mc5.png']});
	}else if(message.content == '$omg'){
		message.channel.send({files: ['https://orig00.deviantart.net/fe83/f/2018/035/1/1/omg_by_sena_nightsaber-dc25mi6.png']});
	}else if(message.content == '$judgingstare'){
	message.channel.send({files: ['https://orig00.deviantart.net/50f1/f/2018/035/d/a/judgingstare_by_sena_nightsaber-dc25n0a.png']});
	}else if(message.content == '$killingstare'){
		message.channel.send({files: ['https://orig00.deviantart.net/c32f/f/2018/035/d/f/killingstare_by_sena_nightsaber-dc25nej.png']});
	}else if(message.content == '$concernedstare'){
		message.channel.send({files: ['https://orig00.deviantart.net/4b48/f/2018/035/5/7/concernedstare_by_sena_nightsaber-dc25ng3.png']});
	}else if(message.content == '$fml'){
		message.channel.send({files: ['https://orig00.deviantart.net/ae99/f/2018/035/e/0/fml_by_sena_nightsaber-dc25nhl.png']});
	}else if(message.content == '$fml2'){
		message.channel.send({files: ['https://orig00.deviantart.net/645b/f/2018/035/b/c/fml2_by_sena_nightsaber-dc25nyi.png']});
	}else if(message.content == '$angrydaria'){
		message.channel.send({files: ['https://orig00.deviantart.net/3f97/f/2018/035/2/2/angrydaria_by_sena_nightsaber-dc25o5o.png']});
	}else if(message.content == '$youtalkshitabtme'){
		message.channel.send({files: ['https://orig00.deviantart.net/6eb2/f/2018/035/d/f/youtalkshitabtme_by_sena_nightsaber-dc25opz.png']});
	}else if(message.content == '$omg2'){
		message.channel.send({files: ['https://orig00.deviantart.net/bfc9/f/2018/035/d/1/omg2_by_sena_nightsaber-dc25owj.png']});
	}else if(message.content == '$dokidoki'){
		message.channel.send({files: ['https://orig00.deviantart.net/ff3e/f/2018/035/7/7/dokidoki_by_sena_nightsaber-dc25p3y.png']});
	}else if(message.content == '$excuseyou'){
		message.channel.send({files: ['https://orig00.deviantart.net/6b12/f/2018/035/4/b/excuseyou_by_sena_nightsaber-dc25p8j.png']});
	}else if(message.content == '$narhmm'){
		message.channel.send({files: ['https://orig00.deviantart.net/8ce4/f/2018/035/5/8/narhmm_by_sena_nightsaber-dc25pme.png']});
	}else if(message.content == '$nopedidnthearyou'){
		message.channel.send({files: ['https://orig00.deviantart.net/0e42/f/2018/035/8/8/nopedidnthearyou_by_sena_nightsaber-dc25pxg.png']});
	}else if(message.content == '$angryroyalistnoises'){
		message.channel.send({files: ['https://orig00.deviantart.net/98fc/f/2018/035/5/3/angryroyalistnoises_by_sena_nightsaber-dc25q4x.png']});
	}else if(message.content == '$angrygabnoises'){
		message.channel.send({files: ['https://orig00.deviantart.net/98fc/f/2018/035/5/3/angryroyalistnoises_by_sena_nightsaber-dc25q4x.png']});
	}else if(message.content == '$bernphoto'){
		message.channel.send({files: ['https://orig00.deviantart.net/3ccc/f/2018/035/c/f/bernphoto_by_sena_nightsaber-dc25rd6.png']});
	}else if(message.content == '$uwu'){
		message.channel.send({files: ['https://orig00.deviantart.net/fdda/f/2018/035/1/5/uwu_by_sena_nightsaber-dc25ref.png']});
	}else if(message.content == '$wantsomedrugs'){
		message.channel.send({files: ['https://orig00.deviantart.net/6686/f/2018/035/9/6/wantsomedrugs_by_sena_nightsaber-dc25rfi.png']});
	}else if(message.content == '$eww'){
		message.channel.send({files: ['https://orig00.deviantart.net/3cce/f/2018/035/2/2/eww_by_sena_nightsaber-dc25rgx.png']});
	}else if(message.content == '$fufufu'){
		message.channel.send({files: ['https://orig00.deviantart.net/99b2/f/2018/035/b/f/fufufu_by_sena_nightsaber-dc25ri9.png']});
	}else if(message.content == '$fufufu2'){
		message.channel.send({files: ['https://orig00.deviantart.net/89d5/f/2018/035/9/4/fufufu2_by_sena_nightsaber-dc25riw.png']});
	}else if(message.content == '$justnormalperson'){
		message.channel.send({files: ['https://orig00.deviantart.net/60a3/f/2018/035/6/6/justnormalperson_by_sena_nightsaber-dc25rpt.png']});
	}else if(message.content == '$verygood'){
		message.channel.send({files: ['https://orig00.deviantart.net/d839/f/2018/035/b/a/verygood_by_sena_nightsaber-dc25ryo.png']});
	}else if(message.content == '$agreed'){
		message.channel.send({files: ['https://orig00.deviantart.net/d839/f/2018/035/b/a/verygood_by_sena_nightsaber-dc25ryo.png']});
	}else if(message.content == '$joshuasmile'){
		message.channel.send({files: ['https://orig00.deviantart.net/26f1/f/2018/035/b/4/joshuasmile_by_sena_nightsaber-dc25s5t.png']});
	}else if(message.content == '$whatdoyoumeankpopsucks'){
		message.channel.send({files: ['https://orig00.deviantart.net/0c3f/f/2018/035/1/e/whatdoyoumeankpopsucks_by_sena_nightsaber-dc25tf7.png']});
	}else if(message.content == '$kylethediva'){
		message.channel.send({files: ['https://orig00.deviantart.net/1f06/f/2018/035/8/b/kylethediva_by_sena_nightsaber-dc25tfz.png']});
	}else if(message.content == '$lipglossendorser'){
		message.channel.send({files: ['https://orig00.deviantart.net/431b/f/2018/035/d/7/lipglossendorser_by_sena_nightsaber-dc25th5.png']});
	}else if(message.content == '$constipatedkyle'){
		message.channel.send({files: ['https://orig00.deviantart.net/8e7c/f/2018/035/9/9/constipatedkyle_by_sena_nightsaber-dc25thm.png']});
	}else if(message.content == '$lifelessstare'){
		message.channel.send({files: ['https://orig00.deviantart.net/9d6f/f/2018/035/1/3/lifelessstare_by_sena_nightsaber-dc25u32.png']});
	}else if(message.content == '$lmaoplebs'){
		message.channel.send({files: ['https://orig00.deviantart.net/76a6/f/2018/035/6/1/lmaoplebs_by_sena_nightsaber-dc25vmu.png']});
	}else if(message.content == '$lmaonoobs'){
		message.channel.send({files: ['https://orig00.deviantart.net/76a6/f/2018/035/6/1/lmaoplebs_by_sena_nightsaber-dc25vmu.png']});
	}else if(message.content == '$kesssmile'){
		message.channel.send({files: ['https://orig00.deviantart.net/bf98/f/2018/035/7/5/kesssmile_by_sena_nightsaber-dc25vu8.png']});
	}else if(message.content == '$lol'){
		message.channel.send({files: ['https://orig00.deviantart.net/5ee7/f/2018/035/4/7/lol_by_sena_nightsaber-dc25w24.png']});
	}else if(message.content == '$codenameleong'){
		message.channel.send({files: ['https://orig00.deviantart.net/2cf8/f/2018/035/6/a/codenameleong_by_sena_nightsaber-dc260ox.png']});
	}else if(message.content == '$thischickenisraw'){
		message.channel.send({files: ['https://orig00.deviantart.net/dd91/f/2018/035/f/b/thischickenisraw_by_sena_nightsaber-dc2611o.png']});
	}else if(message.content == '$bueno'){
		message.channel.send({files: ['https://orig00.deviantart.net/06a6/f/2018/035/1/4/bueno_by_sena_nightsaber-dc261l4.png']});
	}else if(message.content == '$killthemall'){
		message.channel.send({files: ['https://orig00.deviantart.net/b4a9/f/2018/035/9/9/kill_by_sena_nightsaber-dc262ah.png']});
	}else if(message.content == '$illstabyouinthebutt'){
		message.channel.send({files: ['https://orig00.deviantart.net/d15a/f/2018/035/8/d/illstabyouinthebutt_by_sena_nightsaber-dc263iw.png']});
	}else if(message.content == '$bitchslap'){
		message.channel.send({files: ['https://orig00.deviantart.net/3673/f/2018/035/e/4/bitchslap_by_sena_nightsaber-dc26386.png']});
	}else if(message.content == '$lordsunsilk'){
		message.channel.send({files: ['https://orig00.deviantart.net/ca3d/f/2018/035/7/9/lordsunsilk_by_sena_nightsaber-dc263ki.png']});
	}else if(message.content == '$siriushmm'){
		message.channel.send({files: ['https://orig00.deviantart.net/f139/f/2018/035/8/8/siriushmm_by_sena_nightsaber-dc263zg.png']});
	}else if(message.content == '$tch'){
		message.channel.send({files: ['https://orig00.deviantart.net/28ef/f/2018/035/3/a/tch_by_sena_nightsaber-dc2649u.png']});
	}else if(message.content == '$havemercy'){
		message.channel.send({files: ['https://orig00.deviantart.net/e04f/f/2018/035/8/7/havemercy_by_sena_nightsaber-dc264lu.png']});
	}else if(message.content == '$imsorry'){
		message.channel.send({files: ['https://orig00.deviantart.net/2ced/f/2018/035/b/8/imsorry_by_sena_nightsaber-dc265rd.png']});
	}else if(message.content == '!sorry'){
		message.channel.send({files: ['https://orig00.deviantart.net/8798/f/2018/035/5/e/stamp17_by_sorebird-dc267jk.png']});
	}else if(message.content == '!virathanks'){
		message.channel.send({files: ['https://orig00.deviantart.net/4da8/f/2018/035/e/d/stamp186_by_sorebird-dc267j8.png']});
	}else if(message.content == '!viragj'){
		message.channel.send({files: ['https://orig00.deviantart.net/881f/f/2018/035/5/9/stamp187_by_sorebird-dc267ir.png']});
	}else if(message.content == '!aidus'){
		message.channel.send({files: ['https://orig00.deviantart.net/6e12/f/2018/035/f/6/stamp181_by_sorebird-dc267fh.png']});
	}else if(message.content == '!thathurt'){
		message.channel.send({files: ['https://orig00.deviantart.net/cb82/f/2018/035/a/c/stamp192_by_sorebird-dc267ha.png']});
	}else if(message.content == '!stuffed'){
		message.channel.send({files: ['https://orig00.deviantart.net/4dc8/f/2018/035/b/0/stamp176_by_sorebird-dc267g6.png']});
	}else if(message.content == '!comeagain'){
		message.channel.send({files: ['https://orig00.deviantart.net/5599/f/2018/035/d/5/stamp174_by_sorebird-dc267gh.png']});
	}else if(message.content == '!djwelcome'){
		message.channel.send({files: ['https://orig00.deviantart.net/944a/f/2018/035/a/6/stamp173_by_sorebird-dc267fv.png']});
	}else if(message.content == '!viraok'){
		message.channel.send({files: ['https://orig00.deviantart.net/803d/f/2018/035/d/4/stamp191_by_sorebird-dc267gq.png']});
	}else if(message.content == '!viraphalanx'){
		message.channel.send({files: ['https://orig00.deviantart.net/6fa6/f/2018/035/4/f/stamp189_by_sorebird-dc267hy.png']});
	}else if(message.content == '!viradrool'){
		message.channel.send({files: ['https://orig00.deviantart.net/0d38/f/2018/035/1/6/stamp190_by_sorebird-dc267gz.png']});
	}else if(message.content == '!viraheaveho'){
		message.channel.send({files: ['https://orig00.deviantart.net/f337/f/2018/035/2/1/stamp188_by_sorebird-dc267ii.png']});
	}else if(message.content == '!virasup'){
		message.channel.send({files: ['https://orig00.deviantart.net/9b76/f/2018/035/6/a/stamp193_by_sorebird-dc267hp.png']});
	}else if(message.content == '$cry'){
		message.channel.send({files: ['https://orig00.deviantart.net/1737/f/2018/036/c/9/cry_by_sena_nightsaber-dc29e7b.png']});
	}else if(message.content == '$hug'){
		message.channel.send({files: ['https://orig00.deviantart.net/60e4/f/2018/036/a/2/hug_by_sena_nightsaber-dc29ebp.png']});
	}else if(message.content == '$ugu'){
		message.channel.send({files: ['https://orig00.deviantart.net/0594/f/2018/036/0/6/ugu_by_sena_nightsaber-dc29eeb.png']});
	}else if(message.content == '$angryludin'){
		message.channel.send({files: ['https://orig00.deviantart.net/70b4/f/2018/036/1/b/angryludin_by_sena_nightsaber-dc29ef5.png']});
	}else if(message.content == '$stalk'){
		message.channel.send({files: ['https://orig00.deviantart.net/9d5d/f/2018/036/4/4/stalk_by_sena_nightsaber-dc29egm.png']});
	}else if(message.content == '$hailrnggod'){
		message.channel.send({files: ['https://orig00.deviantart.net/0f99/f/2018/036/0/8/hailrngod_by_sena_nightsaber-dc29ulw.png']});
	}else if(message.content == '$nyaa'){
		message.channel.send({files: ['https://orig00.deviantart.net/aed4/f/2018/036/e/d/nyaa_by_sena_nightsaber-dc29uo7.png']});
	}else if(message.content == '$orz'){
		message.channel.send({files: ['https://orig00.deviantart.net/f7ea/f/2018/036/a/5/orz_by_sena_nightsaber-dc29wvh.png']});
	}else if(message.content == '$yawn'){
		message.channel.send({files: ['https://orig00.deviantart.net/e058/f/2018/036/b/3/yawn_by_sena_nightsaber-dc29zat.png']});
	}else if(message.content == '$;_;'){
		message.channel.send({files: ['https://orig00.deviantart.net/32f6/f/2018/038/6/b/__by_sena_nightsaber-dc2gnxh.png']});
	}else if(message.content == '$whaat'){
		message.channel.send({files: ['https://orig00.deviantart.net/ded9/f/2018/038/0/c/whaat_by_sena_nightsaber-dc2gny7.png']});
	}else if(message.content == '$goodluck'){
		message.channel.send({files: ['https://orig00.deviantart.net/ad12/f/2018/038/4/e/goodluck_by_sena_nightsaber-dc2gu47.png']});
	}else if(message.content == '$holdit'){
		message.channel.send({files: ['https://orig00.deviantart.net/0c7d/f/2018/038/d/0/holdit_by_sena_nightsaber-dc2gu6j.png']});
	}else if(message.content == '$peace'){
		message.channel.send({files: ['https://orig00.deviantart.net/d0e9/f/2018/038/d/2/peace_by_sena_nightsaber-dc2gu5g.png']});
	}else if(message.content == '!naruplz'){
		message.channel.send({files: ['https://orig00.deviantart.net/6ed7/f/2018/055/b/a/narupls_by_sorebird-dc47cqy.png']});
		...
		if(message.channel.type == "text" && message.channel.name.toLowerCase() == "bot-related"){
			...
			if(choice != "Bots" && choice != "Members" && role.id != ""){
	...
	message.channel.send({files: ['https://orig00.deviantart.net/a4e8/f/2018/067/e/5/1520534191283_by_sorebird-dc5b103.jpg']});
	}else if(message.content == '!KMRlol' || message.content == '!kmrlol'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/364174595961389086/421385645605519373/dxcbudgvqaas2vm_by_sorebird-dc5b10q.png']});
	}else if(message.content == '!KMRlmao' || message.content == '!kmrlmao'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/364174595961389086/433613115226193920/28468653_2039156589458083_2400986494849253376_n_by_sorebird-dc5b10g.jpg']});
	}else if(message.content == '!NKM' || message.content == '!NKMR' ){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/346757827525607425/435075703898112001/unknown_by_sorebird-dc5b2g5.png']});
	}else if(message.content == '!NKMsad' || message.content == '!NKMRsad' || message.content == '!nkmrsad'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/346295917252444162/595815474046959646/2018_03_04_18_47_36__by_sorebird-dc5b112.png']});
	}else if(message.content == '!NKMrly' || message.content == '!NKMRrly' || message.content == '!nkmrly'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/345648178147753986/432705021994467328/let_me_grind_in_peace_by_sorebird-dc5b11a.png']});
	}else if(message.content == '!onoscratch'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/345648178147753986/634803499661525025/image_by_sorebird-dc5b11f.jpg']});
	}else if(message.content == '!th9'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/345648178147753986/478384542768693249/26733911_10215866732009349_9112396645391563826_n_by_sorebird-dc5b11q.jpg']});
	}else if(message.content == '!veryhardvee'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/345648178147753986/429674341022564353/battleraid_big_bad_shadow_very_hard_by_sorebird-dc5b0qm.png']});
	}else if(message.content == '!gogoclaris'){
	message.channel.send({files: ['https://orig00.deviantart.net/a3fb/f/2018/067/7/2/stamp182_by_sorebird-dc5b0r7.png']});
	}else if(message.content == '!myaha'){
	message.channel.send({files: ['https://orig00.deviantart.net/f604/f/2018/067/e/9/stamp183_by_sorebird-dc5b0ri.png']});
	}else if(message.content == '!leaveittome'){
	message.channel.send({files: ['https://orig00.deviantart.net/e4b5/f/2018/067/f/0/stamp184_by_sorebird-dc5b0ro.png']});
	}else if(message.content == '!vyrncakes'){
	message.channel.send({files: ['https://orig00.deviantart.net/e869/f/2018/067/a/3/stamp71_by_sorebird-dc5b0sq.png']});
	}else if(message.content == '!lunaluheaven'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/345648178147753986/566105139346145280/stamp218_by_sorebird-dc5b0t6.png']});
	}else if(message.content == '!bingo'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/419800151872372737/553897634834939904/stamp217_by_sorebird-dc5b0tg.png']});
	}else if(message.content == '!wombocombo'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/419800151872372737/553898353860018176/stamp216_by_sorebird-dc5b0tt.png']});
	}else if(message.content == '!whoawhoa'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/345648178147753986/599348996934205466/stamp215_by_sorebird-dc5b0u1.png']});
	}else if(message.content == '!good'){
	message.channel.send({files: ['https://orig00.deviantart.net/651f/f/2018/067/3/6/stamp214_by_sorebird-dc5b0ua.png']});
	}else if(message.content == '!nod'){
	 message.channel.send({files: ['https://raw.githubusercontent.com/sorebird/Sorebird-Discord-Bot/master/emote/stamp213_by_sorebird-dc5b0um.png']});
	}else if(message.content == '!geeh' || message.content == '!mugeeh'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/345648178147753986/482919506620973076/stamp195_by_sorebird-dc5b0v0.png']});
	}else if(message.content == '!beawink'){
	message.channel.send({files: ['https://orig00.deviantart.net/33b4/f/2018/067/f/5/stamp212_by_sorebird-dc5b0vc.png']});
	}else if(message.content == '!jadethanks'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/345648178147753986/655263817013526548/stamp211_by_sorebird-dc5b0vk.png']});
	}else if(message.content == '!happyboost'){
	message.channel.send({files: ['https://orig00.deviantart.net/cfb4/f/2018/067/a/6/stamp210_by_sorebird-dc5b0w2.png']});
	}else if(message.content == '!tgif'){
	message.channel.send({files: ['https://orig00.deviantart.net/67f5/f/2018/067/6/3/stamp209_by_sorebird-dc5b0we.png']});
	}else if(message.content == '!durray'){
	message.channel.send({files: ['https://orig00.deviantart.net/ceb0/f/2018/067/3/f/stamp208_by_sorebird-dc5b0wn.png']});
	}else if(message.content == '!lilele'){
	message.channel.send({files: ['https://orig00.deviantart.net/f026/f/2018/067/e/5/stamp207_by_sorebird-dc5b0wv.png']});
	}else if(message.content == '!shing'){
	message.channel.send({files: ['https://orig00.deviantart.net/f4c9/f/2018/067/5/4/stamp206_by_sorebird-dc5b0x5.png']});
	}else if(message.content == '!hoohah'){
	message.channel.send({files: ['https://orig00.deviantart.net/4f9b/f/2018/067/c/1/stamp203_by_sorebird-dc5b0xg.png']});
	}else if(message.content == '!AMAZING'){
	message.channel.send({files: ['https://orig00.deviantart.net/6bb9/f/2018/067/a/b/stamp204_by_sorebird-dc5b0xo.png']});
	}else if(message.content == '!swiftend'){
	message.channel.send({files: ['https://orig00.deviantart.net/4e3a/f/2018/067/9/0/stamp205_by_sorebird-dc5b0xy.png']});
	}else if(message.content == '!burnyou'){
	message.channel.send({files: ['https://orig00.deviantart.net/040c/f/2018/067/f/4/stamp202_by_sorebird-dc5b0y8.png']});
	}else if(message.content == '!wholaughed'){
	message.channel.send({files: ['https://orig00.deviantart.net/762a/f/2018/067/7/6/stamp201_by_sorebird-dc5b0yj.png']});
	}else if(message.content == '!vaneseal'){
	message.channel.send({files: ['https://orig00.deviantart.net/875c/f/2018/067/0/0/stamp200_by_sorebird-dc5b0yq.png']});
	}else if(message.content == '!killervee'){
	message.channel.send({files: ['https://orig00.deviantart.net/427e/f/2018/067/d/e/stamp199_by_sorebird-dc5b0yy.png']});
	}else if(message.content == '!belialmutter'){
	message.channel.send({files: ['https://orig00.deviantart.net/e7f8/f/2018/067/b/9/1520534051085_by_sorebird-dc5b0zk.jpg']});
	}else if(message.content == '!sandalgone'){
	message.channel.send({files: ['https://orig00.deviantart.net/8f31/f/2018/067/7/d/1520534086601_by_sorebird-dc5b0zr.jpg']});
	}else if(message.content == '!tsukio'){
	message.channel.send({files: ['https://orig00.deviantart.net/dc6c/f/2018/067/e/2/screenshot_20180208_145651_by_sorebird-dc5b2gi.jpg']});
	}else if(message.content == '!silence'){
	message.channel.send({files: ['https://orig00.deviantart.net/bc55/f/2018/067/0/3/screenshot_20180208_145330_by_sorebird-dc5b2gd.jpg']});
	}else if(message.content == '$prettyplease'){
	message.channel.send({files: ['https://orig00.deviantart.net/58ea/f/2018/067/d/0/prettyplease_by_sena_nightsaber-dc5axg1.png']});
	}else if(message.content == '$dab' || message.content == '$dablord'){
	message.channel.send({files: ['https://orig00.deviantart.net/2cae/f/2018/067/e/9/dablord_by_sena_nightsaber-dc5axhl.png']});
	}else if(message.content == '!holdit'){
	message.channel.send({files: ['https://orig00.deviantart.net/7905/f/2018/072/0/f/29101955_1628893100561694_6667059639911288697_n_by_sorebird-dc5sk4s.jpg']});
	}else if(message.content == '!icame'){
	message.channel.send({files: ['https://orig00.deviantart.net/c782/f/2018/072/2/a/e28_by_sorebird-dc5sk63.jpg']});
	...
	message.channel.send({files: ['https://orig00.deviantart.net/e350/f/2018/072/f/9/twirl_by_sorebird-dc5slri.png']});
	}else if(message.content == '!nosebleed'){
	message.channel.send({files: ['https://orig00.deviantart.net/6558/f/2018/072/e/3/tyre_by_sorebird-dc5slrc.jpg']});
	}else if(message.content == '!rippots'){
	message.channel.send({files: ['https://orig00.deviantart.net/3bff/f/2018/072/5/a/downloadfile_18_400x280_by_sorebird-dc5slqz.png']});
	}else if(message.content == '!manofculture'){
	message.channel.send({files: ['https://orig00.deviantart.net/8fc3/f/2018/072/7/a/18446754_1739919892689231_4131137197201494572_n_by_sorebird-dc5stys.jpg']});
	}else if(message.content == '!callpolice'){
	message.channel.send({files: ['https://orig00.deviantart.net/d9f3/f/2018/072/a/5/27752074_574140259591239_5977405690976920483_n_by_sorebird-dc5su2m.jpg']});
	}else if(message.content == '!allgood'){
	message.channel.send({files: ['https://orig00.deviantart.net/3f75/f/2018/099/b/c/allgood_by_sorebird-dc8d4p2.png']});
	}else if(message.content == '!nani'){
	message.channel.send({files: ['https://orig00.deviantart.net/f70d/f/2018/099/0/5/nani_by_sorebird-dc8d4ov.jpg']});
	}else if(message.content == '!willlick'){
	message.channel.send({files: ['https://orig00.deviantart.net/5b05/f/2018/099/1/a/willlick_by_sorebird-dc8d4oj.png']});
	}else if(message.content == '!vyrncannon'){
	message.channel.send({files: ['https://orig00.deviantart.net/f48e/f/2018/099/9/5/veecannon_by_sorebird-dc8d4o4.jpg']});
	}else if(message.content == '!bunnyleech'){
	message.channel.send({files: ['https://orig00.deviantart.net/ea26/f/2018/099/b/b/bunnyleech_by_sorebird-dc8d4nu.jpg']});
	}else if(message.content == '!kaguyaleech'){
	message.channel.send({files: ['https://orig00.deviantart.net/ddb9/f/2018/099/8/b/kaguyaleech_by_sorebird-dc8d4ni.jpg']});
	}else if(message.content == '!petnameko'){
	message.channel.send({files: ['https://orig00.deviantart.net/b7e8/f/2018/099/8/d/petnameko_by_sorebird-dc8d4n2.png']});
	}else if(message.content == '!naruhodo'){
	message.channel.send({files: ['https://orig00.deviantart.net/0a58/f/2018/099/b/6/naruhodo_by_sorebird-dc8d4ms.png']});
	}else if(message.content == '!onegai'){
	message.channel.send({files: ['https://orig00.deviantart.net/7f4a/f/2018/099/2/0/onegai_by_sorebird-dc8d4mf.png']});
	}else if(message.content == '!oi'){
	message.channel.send({files: ['https://orig00.deviantart.net/ed29/f/2018/099/b/7/oi_by_sorebird-dc8d4m3.png']});
	}else if(message.content == '!namekoblush'){
	message.channel.send({files: ['https://orig00.deviantart.net/db18/f/2018/099/5/6/blush_by_sorebird-dc8da82.png']});
	}else if(message.content == '!nomcake'){
	message.channel.send({files: ['https://orig00.deviantart.net/16dc/f/2018/099/1/5/cake_by_sorebird-dc8dc7c.png']});
	}else if(message.content == '!blankstare'){
	message.channel.send({files: ['https://orig00.deviantart.net/418f/f/2018/100/0/1/blankvyrn_by_sorebird-dc8gfkf.jpg']});
	}else if(message.content == '!yey'){
	message.channel.send({files: ['https://orig00.deviantart.net/ebcc/f/2018/099/9/b/yey_by_sorebird-dc8d4gf.png']});
	}else if(message.content == '!ohmygod'){
	message.channel.send({files: ['https://orig00.deviantart.net/d6c0/f/2018/099/d/f/ohmygod_by_sorebird-dc8d4gl.png']});
	}else if(message.content == '!hahaha'){
	message.channel.send({files: ['https://orig00.deviantart.net/f0ca/f/2018/099/3/1/hahaha_by_sorebird-dc8d4gu.png']});
	}else if(message.content == '!pancake'){
	message.channel.send({files: ['https://orig00.deviantart.net/e9f0/f/2018/099/b/7/flat_by_sorebird-dc8d4h2.png']});
	}else if(message.content == '!sobbu'){
	message.channel.send({files: ['https://orig00.deviantart.net/37c9/f/2018/099/e/5/sobbu_by_sorebird-dc8dbqe.gif']});
	}else if(message.content == '!weeps'){
	message.channel.send({files: ['https://orig00.deviantart.net/eca7/f/2018/099/a/3/weeps_by_sorebird-dc8dbqh.gif']});
	}else if(message.content == '!wat'){
	message.channel.send({files: ['https://orig00.deviantart.net/729f/f/2018/099/4/2/wat_by_sorebird-dc8dbqy.gif']});
	}else if(message.content == '!imlate'){
	message.channel.send({files: ['https://orig00.deviantart.net/dd3a/f/2018/099/4/7/imlate_by_sorebird-dc8dbr4.gif']});
	}else if(message.content == '!blushu'){
	message.channel.send({files: ['https://orig00.deviantart.net/9144/f/2018/099/e/7/blushu_by_sorebird-dc8dbqn.gif']});
	}else if(message.content == '!goodnight'){
	message.channel.send({files: ['https://orig00.deviantart.net/c9b0/f/2018/099/c/7/goodnight_by_sorebird-dc8dbr3.gif']});
	}else if(message.content == '!foryou'){
	message.channel.send({files: ['https://orig00.deviantart.net/d5d4/f/2018/099/0/c/foryou_by_sorebird-dc8dbqt.gif']});
	}else if(message.content == '!yesgood'){
	message.channel.send({files: ['https://orig00.deviantart.net/6637/f/2018/099/1/7/good_by_sorebird-dc8d815.png']});
	}else if(message.content == '!vyrnsing1'){
	message.channel.send({files: ['https://orig00.deviantart.net/ba34/f/2018/099/9/1/stamp196_by_sorebird-dc8d2cd.png']});
	}else if(message.content == '!vyrnsing2'){
	message.channel.send({files: ['https://orig00.deviantart.net/f5ba/f/2018/099/c/8/stamp197_by_sorebird-dc8d2bz.png']});
	}else if(message.content == '!vyrnsing3'){
	message.channel.send({files: ['https://orig00.deviantart.net/1357/f/2018/099/5/c/stamp198_by_sorebird-dc8d2bl.png']});
	}else if(message.content == '!vyrnwat'){
	message.channel.send({files: ['https://orig00.deviantart.net/6bad/f/2018/099/f/a/sticker__1__by_sorebird-dc8da4w.png']});
	}else if(message.content == '!sneakaway'){
	message.channel.send({files: ['https://orig00.deviantart.net/9ee0/f/2018/099/c/e/sneakaway_by_sorebird-dc8da59.png']});
	}else if(message.content == '!uhnice'){
	message.channel.send({files: ['https://orig00.deviantart.net/d2c0/f/2018/099/f/2/nice_by_sorebird-dc8da4q.png']});
	}else if(message.content == '!np'){
	message.channel.send({files: ['https://orig00.deviantart.net/4360/f/2018/099/b/3/np_by_sorebird-dc8da5l.png']});
	}else if(message.content == '!veryhardbel'){
	message.channel.send({files: ['https://orig00.deviantart.net/d831/f/2018/099/7/1/1520535031195_by_sorebird-dc8d2cs.jpg']});
	...
	message.channel.send({files: ['https://orig00.deviantart.net/6d0b/f/2018/099/0/3/385836621288964099_by_sorebird-dc8d8n3.png']});
	  ...
	  var choice = "Hello I'm "+n+", chirp, ovo, give me a sign, I'm not a Bot!, please be nice to me, I like to bath, please feed me cookies, how are you today, yakuman when, where are my sands, gae bulge ist best weapon ovob";
		...
		message.channel.send({files: ['https://orig00.deviantart.net/ebd5/f/2018/122/3/e/1523645603309_by_sorebird-dcage7i.jpg']});
	}else if(message.content == '!waitth9'){
		message.channel.send({files: ['https://orig00.deviantart.net/e747/f/2018/122/3/a/30706191_10211868486808663_2020887756078579712_n_by_sorebird-dcage79.jpg']});
	}else if(message.content == '!ferryhit'){
		message.channel.send({files: ['https://orig00.deviantart.net/336a/f/2018/122/e/0/1524690734956_by_sorebird-dcage6y.jpg']});
	}else if(message.content == '!KMReyes'){
		message.channel.send({files: ['https://orig00.deviantart.net/c5d6/f/2018/122/6/a/30729066_2487783688114525_3554642365184066015_n_by_sorebird-dcage6k.jpg']});
	}else if(message.content == '!vyrnshock'){
		message.channel.send({files: ['https://orig00.deviantart.net/2d0d/f/2018/122/4/c/30698022_350020905490080_6633791749921701888_n_by_sorebird-dcage68.jpg']});
	}else if(message.content == '!lalala'){
		message.channel.send({files: ['https://orig00.deviantart.net/6914/f/2018/122/7/8/1524690773917_by_sorebird-dcage5z.jpg']});
	}else if(message.content == '!dickpick2'){
		message.channel.send({files: ['https://orig00.deviantart.net/5ac9/f/2018/122/2/9/1523642297073_by_sorebird-dcage5r.jpg']});
	}else if(message.content == '!throwsalt'){
		message.channel.send({files: ['https://orig00.deviantart.net/bc37/f/2018/122/8/a/164971_by_sorebird-dcage5l.jpg']});
	}else if(message.content == '!yaygw'){
		message.channel.send({files: ['https://orig00.deviantart.net/615c/f/2018/122/1/e/yeygw_by_sorebird-dcage57.jpg']});
	}else if(message.content == '!vyrnchoke' || message.content == '!veechoke'){
		message.channel.send({files: ['https://orig00.deviantart.net/8bfe/f/2018/122/5/6/1523786125094_by_sorebird-dcage4z.png']});
	}else if(message.content == '!funfyay' || message.content == '!fifyay'){
		message.channel.send({files: ['https://orig00.deviantart.net/5e58/f/2018/138/5/3/f74447606f1378ac8b1ae5733e5c9cc5_by_sorebird-dcbvkrx.png']});
	}else if(message.content == '!headpat'){
		message.channel.send({files: ['https://orig00.deviantart.net/d43d/f/2018/138/1/5/unknown__2__by_sorebird-dcbvksb.png']});
	}else if(message.content == '!oktostare'){
		message.channel.send({files: ['https://orig00.deviantart.net/de29/f/2018/138/9/d/1525933759358_by_sorebird-dcbvksg.jpg']});
	}else if(message.content == '!funfyey' || message.content == '!fifyey'){
		message.channel.send({files: ['https://orig00.deviantart.net/9da0/f/2018/138/2/d/fiflul_by_sorebird-dcbvksm.jpg']});
	}else if(message.content == '!spitcoffee'){
		message.channel.send({files: ['https://orig00.deviantart.net/ccb8/f/2018/138/a/8/sandalpfft_by_sorebird-dcbvkt0.jpg']});
	}else if(message.content == '!hugfif' || message.content == '!hugfunf'){
		message.channel.send({files: ['https://orig00.deviantart.net/b436/f/2018/138/2/b/e438e3ec05c65909d57f49db9aa3707b_by_sorebird-dcbvktc.png']});
	}else if(message.content == '!proudfif' || message.content == '!proudfunf'){
		message.channel.send({files: ['https://orig00.deviantart.net/a58f/f/2018/138/f/d/63ac9d99fbab201fc90d1a08115836a5_by_sorebird-dcbvktj.png']});
	}else if(message.content == '!chikin'){
		message.channel.send({files: ['https://orig00.deviantart.net/8529/f/2018/138/3/f/chikin_by_sorebird-dcbvku9.jpg']});
	}else if(message.content == '!dontavoid'){
		message.channel.send({files: ['https://orig00.deviantart.net/0b36/f/2018/138/8/5/29597993_1821721274514353_5206856097742737357_n_by_sorebird-dcbvktz.jpg']});
	}else if(message.content == '!night'){
		message.channel.send({files: ['https://orig00.deviantart.net/ab63/f/2018/151/e/1/ded_by_sorebird-dcd1zw2.png']});
	}else if(message.content == '!whyme'){
		message.channel.send({files: ['https://orig00.deviantart.net/b4a4/f/2018/151/e/0/stamp121_by_sorebird-dcd202m.png']});
	}else if(message.content == '!iloveyou'){
		message.channel.send({files: ['https://orig00.deviantart.net/d8f2/f/2018/151/4/e/stamp219_by_sorebird-dcd202w.png']});
	}else if(message.content == '!thumbup'){
		message.channel.send({files: ['https://orig00.deviantart.net/be4c/f/2018/151/4/d/1527766594020_by_sorebird-dcd2034.jpg']});
	}else if(message.content == '!lunaluyes'){
		message.channel.send({files: ['https://orig00.deviantart.net/519b/f/2018/151/f/d/1527753588045_by_sorebird-dcd203a.jpg']});
	}else if(message.content == '!feelmypassion'){
		message.channel.send({files: ['https://orig00.deviantart.net/a243/f/2018/151/9/d/stamp220_by_sorebird-dcd202q.png']});
	}else if(message.content == '!veesigh' || message.content == '!vyrnsigh'){
		message.channel.send({files: ['https://orig00.deviantart.net/65fb/f/2018/151/1/f/sigh2_by_sorebird-dcd20j6.png']});
	}else if(message.content == '!cagshock'){
		message.channel.send({files: ['https://orig00.deviantart.net/5e13/f/2018/151/7/5/cagshock_by_sorebird-dcd20jq.png']});
	}else if(message.content == '!glitter'){
		message.channel.send({files: ['https://orig00.deviantart.net/b2cb/f/2018/151/4/6/glitter_by_sorebird-dcd20jh.png']});
	}else if(message.content == '!niong'){
		message.channel.send({files: ['https://orig00.deviantart.net/fae0/f/2018/151/0/0/niong_by_sorebird-dcd20jb.png']});
	}else if(message.content == '!hellopolice'){
		message.channel.send({files: ['https://orig00.deviantart.net/7f95/f/2018/154/0/3/34302679_1078202778985790_384197404586409984_n_by_sorebird-dcdbl0e.jpg']});
	}else if(message.content == '!funfwow' || message.content == '!fifwow'){
		message.channel.send({files: ['https://orig00.deviantart.net/aa7b/f/2018/168/6/c/screen_shot_2018_06_12_at_7_27_22_pm_by_sorebird-dcenu0y.png']});
	}else if(message.content == '!cheersore'){
		message.channel.send({files: ['https://orig00.deviantart.net/20d0/f/2018/168/1/8/cheersoreillia1_by_sorebird-dcenu0l.png']});
	}else if(message.content == '!tlepilli'){
		message.channel.send({files: ['https://orig00.deviantart.net/6109/f/2018/168/7/3/tlepilli_by_sorebird-dcenu0c.png']});
	}else if(message.content == '!jin'){
		message.channel.send({files: ['https://orig00.deviantart.net/c9f4/f/2018/168/0/7/jinstare_by_sorebird-dcenu03.jpg']});
	}else if(message.content == '!dance'){
		message.channel.send({files: ['https://orig00.deviantart.net/258d/f/2018/168/e/2/1514654716901_by_sorebird-dcenu19.gif']});
	}else if(message.content == '!chikinyay'){
		message.channel.send({files: ['https://orig00.deviantart.net/00c8/f/2018/168/4/f/screenshot_20180608_110536_granblue_by_sorebird-dcenu1f.jpg']});
	}else if(message.content == '!deviltrigger'){
		message.channel.send({files: ['https://orig00.deviantart.net/9a82/f/2018/168/0/9/7ad_by_sorebird-dcenuo9.jpg']});
	}else if(message.content == '!motivated'){
		message.channel.send({files: ['https://orig00.deviantart.net/3787/f/2018/168/b/0/d5d_by_sorebird-dcenv4g.jpg']});
	}else if(message.content == '!korwawryy'){
		message.channel.send({files: ['https://orig00.deviantart.net/378c/f/2018/168/c/2/4383c10676d215197d28b70b8f2fa1ec_by_sorebird-dcenvp8.png']});
	}else if(message.content == '!urgh'){
		message.channel.send({files: ['https://orig00.deviantart.net/dbb2/f/2018/168/3/f/55c2314cb64ad7884fd3eec288e25b54_by_sorebird-dcenvpo.png']});
	}else if(message.content == '!veewut' || message.content == '!vyrnwut'){
		message.channel.send({files: ['https://orig00.deviantart.net/58f7/f/2018/168/b/d/vyrnwat_by_sorebird-dcenvr3.png']});
	}else if(message.content == '!omoshiroi'){
		message.channel.send({files: ['https://orig00.deviantart.net/d84e/f/2018/189/3/9/eahta_ii_by_sorebird-dcglx8i.png']});
	}else if(message.content == '!feelsdante'){
		message.channel.send({files: ['https://orig00.deviantart.net/8288/f/2018/189/7/9/1529786051952_by_sorebird-dcglx8n.jpg']});
	}else if(message.content == '!boldgar'){
		message.channel.send({files: ['https://orig00.deviantart.net/ae79/f/2018/189/2/a/boldgar_by_sorebird-dcglx8v.png']});
	}else if(message.content == '!sandal'){
		message.channel.send({files: ['https://orig00.deviantart.net/9e23/f/2018/189/9/9/sandal_by_sorebird-dcglx8x.png']});
	}else if(message.content == '!pizza'){
		message.channel.send({files: ['https://orig00.deviantart.net/aa34/f/2018/189/7/d/pizza_by_sorebird-dcglx94.gif']});
	}else if(message.content == '!judging'){
		message.channel.send({files: ['https://orig00.deviantart.net/438a/f/2018/189/a/5/1529855971489_by_sorebird-dcglx96.jpg']});
	}else if(message.content == '!nioshock'){
		message.channel.send({files: ['https://orig00.deviantart.net/8825/f/2018/189/c/1/unknown__3__by_sorebird-dcglx9c.png']});
	}else if(message.content == '!kisama'){
		message.channel.send({files: ['https://orig00.deviantart.net/8c76/f/2018/189/1/4/unknown__4__by_sorebird-dcglx9i.png']});
	}else if(message.content == '!katcooking'){
		message.channel.send({files: ['https://orig00.deviantart.net/fddb/f/2018/189/4/d/1529925143184_by_sorebird-dcglx9n.jpg']});
	}else if(message.content == '!angriboi'){
		message.channel.send({files: ['https://orig00.deviantart.net/d570/f/2018/189/8/1/screen_shot_2018_06_21_at_11_32_29_pm_by_sorebird-dcglx9s.png']});
	}else if(message.content == '!eustacethink'){
		message.channel.send({files: ['https://orig00.deviantart.net/dbe1/f/2018/189/8/d/euthink_by_sorebird-dcglx9z.jpg']});
	}else if(message.content == '!quatre'){
		message.channel.send({files: ['https://orig00.deviantart.net/0c3e/f/2018/189/c/0/quatre_by_sorebird-dcglxa3.jpg']});
	}else if(message.content == '!nocomment'){
		message.channel.send({files: ['https://orig00.deviantart.net/f819/f/2018/189/e/a/nocomment_by_sorebird-dcglxab.png']});
	}else if(message.content == '!smugcag'){
		message.channel.send({files: ['https://orig00.deviantart.net/58f9/f/2018/189/8/f/smugcag_by_sorebird-dcglxah.png']});
	}else if(message.content == '!scoldme'){
		message.channel.send({files: ['https://orig00.deviantart.net/cd73/f/2018/189/4/e/1531050049372_by_sorebird-dcgly75.jpg']});
	}else if(message.content == '!covereye' || message.content == '!coverseyes' || message.content == '!covereyes'){
		message.channel.send({files: ['https://orig00.deviantart.net/28d0/f/2018/189/f/5/1531050066836_by_sorebird-dcgly7b.jpg']});
	}else if(message.content == '!aegismerge'){
		message.channel.send({files: ['https://orig00.deviantart.net/d6c9/f/2018/260/a/0/aegismerge_by_sorebird-dcn2qpg.png']});
	}else if(message.content == '!approved'){
			message.channel.send({files: ['https://orig00.deviantart.net/d8d6/f/2018/260/f/1/approved_by_sorebird-dcn2qpa.png']});
	}else if(message.content == '!bedoclock'){
			message.channel.send({files: ['https://orig00.deviantart.net/0d93/f/2018/260/6/4/bedoclock_by_sorebird-dcn2qp3.jpg']});
	}else if(message.content == '!belialsigh'){
			message.channel.send({files: ['https://orig00.deviantart.net/7f4c/f/2018/260/9/5/belialsigh_by_sorebird-dcn2qot.png']});
	}else if(message.content == '!browhat'){
			message.channel.send({files: ['https://orig00.deviantart.net/09a8/f/2018/260/5/4/bro_what_by_sorebird-dcn2qop.png']});
	}else if(message.content == '!chikinslacc'){
			message.channel.send({files: ['https://orig00.deviantart.net/03f2/f/2018/260/e/9/chikinslacc_by_sorebird-dcn2qoo.jpg']});
	}else if(message.content == '!crashed'){
			message.channel.send({files: ['https://orig00.deviantart.net/f0a6/f/2018/260/f/0/crushedhope_by_sorebird-dcn2qon.jpg']});
	}else if(message.content == '!cagtehe'){
			message.channel.send({files: ['https://orig00.deviantart.net/0bd7/f/2018/260/8/2/cutest_by_sorebird-dcn2qog.jpg']});
	}else if(message.content == '!dante'){
			message.channel.send({files: ['https://orig00.deviantart.net/2f78/f/2018/260/c/1/devil_may_cry_4_dante_dante_39278436_500_275_by_sorebird-dcn2qod.gif']});
	}else if(message.content == '!elmotthuh'){
			message.channel.send({files: ['https://orig00.deviantart.net/4f8b/f/2018/260/8/9/elmotthuh_by_sorebird-dcn2qo6.png']});
	}else if(message.content == '!fish'){
			message.channel.send({files: ['https://orig00.deviantart.net/038b/f/2018/260/2/7/fish_by_sorebird-dcn2qo5.png']});
	}else if(message.content == '!glomps'){
			message.channel.send({files: ['https://orig00.deviantart.net/0dc5/f/2018/260/9/2/glomps_by_sorebird-dcn2qo4.jpg']});
	}else if(message.content == '!godie'){
			message.channel.send({files: ['https://orig00.deviantart.net/bd51/f/2018/260/4/0/godie_by_sorebird-dcn2qo2.png']});
	}else if(message.content == '!imsalty'){
			message.channel.send({files: ['https://orig00.deviantart.net/825b/f/2018/260/1/3/imsalty_by_sorebird-dcn2qnz.jpg']});
	}else if(message.content == '!kicks'){
			message.channel.send({files: ['https://orig00.deviantart.net/08f5/f/2018/260/5/5/kicks_by_sorebird-dcn2qnt.png']});
	}else if(message.content == '!nobonito'){
			message.channel.send({files: ['https://orig00.deviantart.net/02ed/f/2018/260/a/e/nobonito_by_sorebird-dcn2qno.png']});
	}else if(message.content == '!pholiashock'){
			message.channel.send({files: ['https://orig00.deviantart.net/855d/f/2018/260/f/6/pholiashock_by_sorebird-dcn2qnk.jpg']});
	}else if(message.content == '!pholiathink'){
			message.channel.send({files: ['https://orig00.deviantart.net/b3cb/f/2018/260/5/a/pholiathink_by_sorebird-dcn2qng.jpg']});
	}else if(message.content == '!sietedespair'){
			message.channel.send({files: ['https://orig00.deviantart.net/ed98/f/2018/260/3/2/sietedespair_by_sorebird-dcn2qnc.jpg']});
	}else if(message.content == '!sieteshock'){
			message.channel.send({files: ['https://orig00.deviantart.net/98ac/f/2018/260/6/2/sieteshock_by_sorebird-dcn2qn9.jpg']});
	}else if(message.content == '!cagsway'){
			message.channel.send({files: ['https://orig00.deviantart.net/326d/f/2018/260/0/a/sway_by_sorebird-dcn2qn5.jpg']});
	}else if(message.content == '!percyvroom'){
			message.channel.send({files: ['https://orig00.deviantart.net/d225/f/2018/260/9/6/vroom_by_sorebird-dcn2qn1.jpg']});
	}else if(message.content == '!vyrnstamp'){
			message.channel.send({files: ['https://orig00.deviantart.net/27b6/f/2018/260/4/0/vyrnstamp_by_sorebird-dcn2qmw.png']});
	}else if(message.content == '!dafck'){
			message.channel.send({files: ['https://orig00.deviantart.net/cc04/f/2018/260/f/3/whatamireading_by_sorebird-dcn2qmn.jpg']});
	}else if(message.content == '!woof'){
			message.channel.send({files: ['https://orig00.deviantart.net/6bea/f/2018/260/3/1/woof_by_sorebird-dcn2qmj.png']});
	}else if(message.content == '!zoerry'){
			message.channel.send({files: ['https://orig00.deviantart.net/1550/f/2018/260/7/a/zoerry_by_sorebird-dcn2qma.png']});
		...
		message.channel.send({files: ['https://raw.githubusercontent.com/sorebird/Sorebird-Discord-Bot/master/emote/coverears.jpg']});
		...
		message.channel.send({files: ['https://raw.githubusercontent.com/sorebird/Sorebird-Discord-Bot/master/emote/lyriaded.jpg']});
		...
		message.channel.send({files: ['https://raw.githubusercontent.com/sorebird/Sorebird-Discord-Bot/master/emote/timetoscum.png']});
	}else if(message.content == '!derpyheles'){
		message.channel.send({files: ['https://raw.githubusercontent.com/sorebird/Sorebird-Discord-Bot/master/emote/derpyheles.jpg']});
		...
		message.channel.send({files: ['https://raw.githubusercontent.com/sorebird/Sorebird-Discord-Bot/master/emote/lilysmile.jpg']});
		...
		message.channel.send({files: ['https://raw.githubusercontent.com/sorebird/Sorebird-Discord-Bot/master/emote/uwu.png']});
	}else if(message.content == '!uwusun'){
	    message.channel.send({files: ['https://raw.githubusercontent.com/sorebird/Sorebird-Discord-Bot/master/emote/uwusun.jpg']});
		...
		message.channel.send({files: ['https://orig00.deviantart.net/5d85/f/2019/075/a/e/itspastyourbedtime_by_sorebird-dd28o4s.gif']});
	}else if(message.content == '!outofmyway'){
		//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/556481069960921088/outofmyway.jpg']});
	}else if(message.content == '!vyrnzilla'){
		//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/556480436851834882/Stamp240.png']});
	}else if(message.content == '!deathgame'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/556480433475551262/Stamp239.png']});
	}else if(message.content == '!cominthrough'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/556480430308720650/Stamp238.png']});
	}else if(message.content == '!notonmywatch'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/556480426609475585/Stamp237.png']});
	}else if(message.content == '!gotthis'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/556480423153106964/Stamp236.png']});
	}else if(message.content == '!whew'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/556480418799419453/Stamp235.png']});
	}else if(message.content == '!sandalstare'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/556480555923931158/unknown.png']});
	}else if(message.content == '!socieshock'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/556480369017487394/image0.png']});
	}else if(message.content == '!6m'){
	message.channel.send({files: ['https://raw.githubusercontent.com/sorebird/Sorebird-Discord-Bot/master/emote/6m.png']});
	}else if(message.content == '!smugsiero'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/556480543844335656/unknown_1.png']});
	}else if(message.content == '!sandalshock'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/556480364248301603/image0_5.png']});
	}else if(message.content == '!senpout'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/556480408670306304/senpout.jpg']});
	}else if(message.content == '!tienstare'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/556480537527844885/tienstare.jpg']});
	}else if(message.content == '!tiawaa'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/556480530804375562/tiagun.png']});
	}else if(message.content == '!seoxcry'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/556480414932402176/seoxcry.png']});
	}else if(message.content == '!quatrestare'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/556480397148684290/quatrestare.png']});
	}else if(message.content == '!niostare'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/556485333454422016/niostare.png']});
	}else if(message.content == '!societhonk'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/556480362021126154/image0_1.png']});
	}else if(message.content == '!tsuku'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/556480359584497684/image0_1.jpg']});
	}else if(message.content == '!belialthonk'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/556480549988859911/unknown_2.png']});
	}else if(message.content == '!granthonk'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/556480354698002434/D072hCQVYAEVeHd.png']});
	}else if(message.content == '!djthonk'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/556480352194002947/D072hCDUwAAbVJ1.png']});
	}else if(message.content == '!hadesstare'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/556480356530782210/hades_stare.png']});
	}else if(message.content == '!belialsurprise'){
		//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/556480343037706270/5df31a0d9a47ec5745e7ac252437b2f3.png']});
	}else if(message.content == '!kmrwat'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/556480347542519808/471166274819325973.png']});
	}else if(message.content == '!tpose'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/556480526127726613/Stamp261.png']});
	}else if(message.content == '!ilike'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/556480521795010601/Stamp260.png']});
	}else if(message.content == '!gislarocks'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/556480518061817910/Stamp259.png']});
	}else if(message.content == '!Idoit'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/556480512575799296/Stamp258.png']});
	}else if(message.content == '!chills'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/556480508725297172/Stamp257.png']});
	}else if(message.content == '!destiny'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/556480503809572875/Stamp256.png']});
	}else if(message.content == '!ratherdie'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/556485446029410315/Stamp255.png']});
	}else if(message.content == '!waytogo'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/556480495395930118/Stamp254.png']});
	}else if(message.content == '!problem?'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/556480491029659658/Stamp253.png']});
	}else if(message.content == '!moni'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/556485506062483471/Stamp252.png']});
	}else if(message.content == '!europal'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/556485503784976384/Stamp251.png']});
	}else if(message.content == '!alexello'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/556480470746136597/Stamp250.png']});
	}else if(message.content == '!veight'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/556480467403014185/Stamp249.png']});
	}else if(message.content == '!vampy'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/556480463712026639/Stamp248.png']});
	}else if(message.content == '!fifgold'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/556480459610128421/Stamp247.png']});
	}else if(message.content == '!songpara'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/556480456120467478/Stamp246.png']});
	}else if(message.content == '!naruconfused'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/556480452374822912/Stamp245.png']});
	}else if(message.content == '!playwithme'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/556485565248307212/Stamp244.png']});
	}else if(message.content == '!thwack'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/556480445550952468/Stamp243.png']});
	}else if(message.content == '!pumpitup'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/556480442325401642/Stamp242.png']});
	}else if(message.content == '!dontgetit'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/556480439569874954/Stamp241.png']});
	}else if(message.content == '!notwritten'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/556485601105412115/notwritten.jpg']});
	}else if(message.content == '!cagshock'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/580141715000786975/cagshock.png']});
	}else if(message.content == '!deadweight'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/580141717047738374/deadweight.jpg']});
	}else if(message.content == '!goldbarpls'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/580141720511971336/gbpls.png']});
	}else if(message.content == '!geohuh'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/580141721019482124/geohuh.png']});
	}else if(message.content == '!givepraise'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/580141724106489862/givepraise.png']});
	}else if(message.content == '!hottievyrn'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/580141726413619247/hottievyrn.png']});
	}else if(message.content == '!kmrgisla'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/580141728120700941/kmrgisla.jpg']});
	}else if(message.content == '!kmrjerry'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/580141731941580810/kmrjerry.png']});
	}else if(message.content == '!letmeslacc'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/580141733959172099/letmeslacc.png']});
	}else if(message.content == '!lucihuh'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/580141738262265925/luciwut.png']});
	}else if(message.content == '!mygoldbar'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/580142406574407710/mygoldbar.png']});
	}else if(message.content == '!myrainbow'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/580141758172758016/myrainbow.png']});
	}else if(message.content == '!nappls'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/580141765345148928/nappls.jpg']});
	}else if(message.content == '!nerohuh'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/580141772823461908/nerohuh.jpg']});
	}else if(message.content == '!nezhanod'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/580141776770433045/nezhanod.jpg']});
	}else if(message.content == '!ripfriday'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/580141781186772992/ripfriday.png']});
	}else if(message.content == '!saltpls'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/580141786438303765/saltpls.png']});
	}else if(message.content == '!shaocry'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/580141792100614144/shaocry.jpg']});
	}else if(message.content == '!shaoshock'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/580141800652668968/shaoshock.jpg']});
	}else if(message.content == '!sietesmile'){
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/580141806944256020/sietesmile.png']});
	...
	//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/630111687516880918/Stamp235.png']});
	}
	else if(message.content == '!ooh'){
		//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/630111704814059520/Stamp262.png']});
	}
	else if(message.content == '!chuuni'){
		//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/630111722061037570/Stamp263.png']});
	}
	else if(message.content == '!waah'){
		//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/630111740658581545/Stamp264.png']});
	}
	else if(message.content == '!thumbsup2'){
		//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/630111763496566815/Stamp265.png']});
	}
	else if(message.content == '!rockfish'){
		//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/630111785755738143/Stamp266.png']});
	}
	else if(message.content == '!heehaw'){
		//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/630111853095157795/Stamp232.png']});
	}
	else if(message.content == '!shloop'){
		//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/630111895789109248/Stamp234.png']});
	}
	else if(message.content == '!varuna'){
		//message.channel.send({files: ['https://cdn.discordapp.com/attachments/482826784627359744/580748041527492618/unknown.png']});
	}
	else if(message.content == '!eustacesleep'){
		//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/630113613092356097/unknown.png']});
	}
	else if(message.content == '!niercry'){
		//message.channel.send({files: ['https://cdn.discordapp.com/attachments/207220212519403521/584276679787020308/557372033629945858.png']});
	}
	else if(message.content == '!freyrbonito'){
		//message.channel.send({files: ['https://cdn.discordapp.com/attachments/482826784627359744/584747459058597892/image0.jpg']});
	}
	else if(message.content == '!quatreshook'){
		//message.channel.send({files: ['https://cdn.discordapp.com/attachments/482826784627359744/584892255844696070/image0.jpg']});
	}
	else if(message.content == '!worriedferry'){
		//message.channel.send({files: ['https://cdn.discordapp.com/attachments/482826784627359744/585092774068486147/FB_IMG_1559567376086.jpg']});
	}
	else if(message.content == '!death'){
		//message.channel.send({files: ['https://cdn.discordapp.com/attachments/207220212519403521/586223417133367297/20190605_214101.jpg']});
	}
	else if(message.content == '!quatrehuh'){
		//message.channel.send({files: ['https://cdn.discordapp.com/attachments/482826784627359744/587341534677172234/image0.jpg']});
	}
	else if(message.content == '!nierpout'){
		//message.channel.send({files: ['https://cdn.discordapp.com/attachments/207220212519403521/588764657989189673/NierPout.png']});
	}
	else if(message.content == '!europasmile'){
		//message.channel.send({files: ['https://cdn.discordapp.com/attachments/482826784627359744/601003639535960091/unknown.png']});
	}
	else if(message.content == '!spoilersplz'){
		//message.channel.send({files: ['https://cdn.discordapp.com/attachments/482826784627359744/601096285910728704/1563382725420.jpg']});
	}
	else if(message.content == '!excooseme'){
		//message.channel.send({files: ['https://cdn.discordapp.com/attachments/482826784627359744/601793617446567960/FB_IMG_1563549152528.jpg']});
	}
		...
		message.channel.send({files: ['https://raw.githubusercontent.com/sorebird/Sorebird-Discord-Bot/master/emote/phosphorus.gif']});
	}
		...
		//message.channel.send({files: ['https://cdn.discordapp.com/attachments/544576495595683861/630114952635482123/unknown.png']});
	}
	else if(message.content == '!sadkermit'){
		//message.channel.send({files: ['https://cdn.discordapp.com/attachments/482826784627359744/606189599672369152/EA0tOtlVAAABHgp.png']});
	}
	else if(message.content == '!verysadnkmr'){
		//message.channel.send({files: ['https://cdn.discordapp.com/attachments/482826784627359744/608781296604545060/yuichi_nakamura_sad_face.jpg']});
	}
	else if(message.content == '!beastop'){
		//message.channel.send({files: ['https://cdn.discordapp.com/attachments/482826784627359744/609450074686357524/20190809_191640.jpg']});
	}
	else if(message.content == '!whatdeleteplz'){
		//message.channel.send({files: ['https://cdn.discordapp.com/attachments/482826784627359744/612028146241241102/FB_IMG_1560407078283.jpg']});
	}
	else if(message.content == '!medusathink'){
		//message.channel.send({files: ['https://cdn.discordapp.com/attachments/482826784627359744/612238119676411955/image0.jpg']});
	}
	else if(message.content == '!seruelstare'){
		//message.channel.send({files: ['https://cdn.discordapp.com/attachments/482826784627359744/613633670959333377/unknown.png']});
	}
	else if(message.content == '!nierplz'){
		//message.channel.send({files: ['https://cdn.discordapp.com/emojis/620278213431787530.png']});
	}
	else if(message.content == '!stanthink'){
		//message.channel.send({files: ['https://cdn.discordapp.com/attachments/482826784627359744/620511984147890176/unknown.png']});
	}
	else if(message.content == '!nier'){
		//message.channel.send({files: ['https://cdn.discordapp.com/attachments/482826784627359744/626254401421705226/image0.png']});
	}
	else if(message.content == '!notdeadweight'){
		message.channel.send({files: ['https://66.media.tumblr.com/9c5c3f4dba73e41dfc8d35f2f32ebdb7/tumblr_pqjfvy3Rt81r5lxoeo1_250.png']});
	}
	else if(message.content == '!soitiswritten'){
		message.channel.send({files: ['https://66.media.tumblr.com/0243c2c2b7366d94319545c90c5be30e/tumblr_pqjfvy3Rt81r5lxoeo2_250.png']});
	}
	else if(message.content == '!whereisyourmotivation'){
		message.channel.send({files: ['https://66.media.tumblr.com/a5854c2380030f4df658fe24e96a4880/tumblr_pqlhmkujHV1r5lxoeo1_250.png']});
	}
	else if(message.content == '!pizzatime'){
		message.channel.send({files: ['https://66.media.tumblr.com/bd08cb7915bac9e27ee43bb5cf84f040/tumblr_pqlhmkujHV1r5lxoeo2_250.png']});
	}else if(message.content == '!30kpls'){
		message.channel.send({files: ['https://raw.githubusercontent.com/sorebird/Sorebird-Discord-Bot/master/emote/30k_ahoy.png']});
		...
		//message.channel.send({files: ['https://cdn.discordapp.com/emojis/598936843404181514.png']});
	}else if(message.content == '!vikalapout'){
		//message.channel.send({files: ['https://cdn.discordapp.com/attachments/482826784627359744/670092897307328552/82329184_2726441950810555_7646550664725659648_n.png']});
	}else if(message.content == '!fullauto'){
		//message.channel.send({files: ['https://cdn.discordapp.com/attachments/482826784627359744/669923847931428874/ca3z4jn1igc41.png']});
	}else if(message.content == '!helespout'){
		//message.channel.send({files: ['https://cdn.discordapp.com/attachments/482826784627359744/655716408545509376/907632f4e7341d1e00a95d05d25c2b7b.png']});
	}else if(message.content == '!thankyoufrost'){
		//message.channel.send({files: ['https://cdn.discordapp.com/attachments/482826784627359744/655346670040645654/unknown.png']});
	}else if(message.content == '!vyrnsleep'){
		//message.channel.send({files: ['https://cdn.discordapp.com/attachments/482826784627359744/655330665813770240/unknown.png']});
	}else if(message.content == '!europasleep'){
		//message.channel.send({files: ['https://cdn.discordapp.com/emojis/631713442923020308.png']});
	}else if(message.content == '!djohno'){
		//message.channel.send({files: ['https://cdn.discordapp.com/attachments/482826784627359744/649188377190727701/FB_IMG_1574848958691.jpg']});
	}else if(message.content == '!facepalm'){
		//message.channel.send({files: ['https://cdn.discordapp.com/emojis/722450262668608600.png']});
	}else if(message.content == '!danzai'){
		//message.channel.send({files: ['https://cdn.discordapp.com/attachments/430196903905460224/722472849486643360/DANZAI.gif']});
	}else if(message.content == '!ssrplz'){
		message.channel.send({files: ['https://i.gyazo.com/ecb89109bcd5be5d6a1aa2d36e992def.png']});
	}else if(message.content == '!sieteshy'){
		//message.channel.send({files: ['https://cdn.discordapp.com/attachments/482826784627359744/708560778575347743/20200509_070718.png']});
	}else if(message.content == '!caimsip'){
		//message.channel.send({files: ['https://cdn.discordapp.com/attachments/482826784627359744/701152742948864070/caimsip.png']});
	}else if(message.content == '!steponme'){
		//message.channel.send({files: ['https://cdn.discordapp.com/attachments/430196903905460224/722523490703507466/steponme.png']});
	}else if(message.content == '!luciosmile'){
		//message.channel.send({files: ['https://cdn.discordapp.com/attachments/430196903905460224/722504561641652314/2.png']});
	}else if(message.content == '!sandalsip'){
		//message.channel.send({files: ['https://cdn.discordapp.com/attachments/482826784627359744/733282040828657664/Clipboard02.png']});
	}else if(message.content == '!beliallaugh'){
		//message.channel.send({files: ['https://cdn.discordapp.com/attachments/482826784627359744/739335435414667285/EeXJdjbWsAACJul.png']});
	}else if(message.content == '!tiredofbeingnice'){
		//message.channel.send({files: ['https://cdn.discordapp.com/attachments/482826784627359744/767468649098379284/EeXJJ_oXoAQRTha.jpg']});
	}else if(message.content == '!luciodrink'){
		//message.channel.send({files: ['https://cdn.discordapp.com/attachments/482826784627359744/767468651662016533/EeXJKp2XgAEn3CY.jpg']});
	}else if(message.content == '!vikalaoww'){
		//message.channel.send({files: ['https://cdn.discordapp.com/attachments/482826784627359744/767468652604686366/EeXJKUBWAAEHoFG.jpg']});
		...
		const avatarList = message.mentions.users.map(user => {
			message.channel.send({files: [user.displayAvatarURL({ format: "png", dynamic: true })]});
		...
		message.channel.send({files: ['https://raw.githubusercontent.com/sorebird/Sorebird-Discord-Bot/master/emote/bearsit.gif']});
		...
		message.channel.send({files: ['https://raw.githubusercontent.com/sorebird/Sorebird-Discord-Bot/master/emote/ezgif.com-resize_12.gif']});
	}else if(message.content == '!s_urgh'){
		message.channel.send({files: ['https://raw.githubusercontent.com/sorebird/Sorebird-Discord-Bot/master/emote/sorebird_urgh.png']});
	}else if(message.content == '!s_wave' || message.content == '!s_hi'){
		message.channel.send({files: ['https://raw.githubusercontent.com/sorebird/Sorebird-Discord-Bot/master/emote/sorebird_wave.gif']});
	}else if(message.content == '!s_amazed' || message.content == '!s_wow'){
	...
	}else if(message.content == '!s_gift'){
		message.channel.send({files: ['https://raw.githubusercontent.com/sorebird/Sorebird-Discord-Bot/master/emote/sorebird_gift.png']});
	}else if(message.content == '!s_gisla'){
		message.channel.send({files: ['https://raw.githubusercontent.com/sorebird/Sorebird-Discord-Bot/master/emote/sorebird_gisla.png']});
	}else if(message.content == '!s_heart'){
		message.channel.send({files: ['https://raw.githubusercontent.com/sorebird/Sorebird-Discord-Bot/master/emote/sorebird_heart.png']});
	}else if(message.content == '!s_hide'){
		message.channel.send({files: ['https://raw.githubusercontent.com/sorebird/Sorebird-Discord-Bot/master/emote/sorebird_hide.gif']});
	}else if(message.content == '!s_huh'){
		message.channel.send({files: ['https://raw.githubusercontent.com/sorebird/Sorebird-Discord-Bot/master/emote/sorebird_huh.gif']});
	}else if(message.content == '!s_nom'){
		message.channel.send({files: ['https://raw.githubusercontent.com/sorebird/Sorebird-Discord-Bot/master/emote/sorebird_nom.gif']});
		...
		message.channel.send({files: ['https://raw.githubusercontent.com/sorebird/Sorebird-Discord-Bot/master/emote/sorebird_pout.gif']});
